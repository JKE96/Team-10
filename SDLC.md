...
##SDLC Design##
When designing an information system, you need to make sure that all of the requirements are met, or the information system will not work as expected.  Making sure that the requirements are met will make sure that the system is completely thorough also and make sure that the clients and people using the system are getting what they are expected to get from the system.  When designing a system there are many factors and things to consider such as the specifications, what will hold the information, and the general way that it will be built.  In class we have made UML diagrams to help us consider the steps that will take place when the information system will be used.  Designing an information system is usually focused around making sure that the system is working as planned instead of focusing on things such as how great the system looks for users.  When designing an information system, it is better to make sure the requirements are met for it and then focus on things such as how great the system looks for the users, because having an alright looking system that works perfectly is better than a great looking information system that does not work as expected or does not meet the needed requirements.
